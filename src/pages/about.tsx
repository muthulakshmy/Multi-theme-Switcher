  ...
  return (
    ...
    >
      ...
      <p className="z-10 text-center text-base mb-4  drop-shadow-lg">
        We are a multi-store brand committed to delivering quality products and
        reliable service across all our locations. With multiple stores
        operating under one system, we provide a seamless shopping
